"""
Django settings for trainee_survey project.
...
ROOT_URLCONF = 'trainee_survey.urls'
...
WSGI_APPLICATION = 'trainee_survey.wsgi.application'
...
auth_user_model = 'formsapp.CustomUser'