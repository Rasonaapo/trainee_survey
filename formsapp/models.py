...
class SurveyResponse(models.Model):
    ...
    ghana_card = models.CharField(max_length=25,  verbose_name="Ghana Card Number", help_text="e.g. GHA-12345789-1", validators=[ghana_card_validator], unique=True)
    ssnit_number = models.CharField(max_length=20, blank=True, null=True, unique=True, verbose_name="SSNIT Number")
    ...
    account_number = models.CharField(max_length=20, unique=True, verbose_name="Bank Account Number")
